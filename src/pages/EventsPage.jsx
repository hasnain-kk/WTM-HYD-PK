  ...
  return (
    <div className="layout-section" style={{ background: `linear-gradient(rgba(255,255,255,0.8), rgba(255,255,255,0.95)), url("${eventsBg}") center/cover border-box` }}>
      <div className="grid-container">
        <h1 style={{ fontSize: 'clamp(2.5rem, 8vw, 4rem)', marginBottom: 'clamp(32px, 8vw, 48px)', textAlign: 'center', color: 'var(--deep-blue)', maxWidth: '100%' }}>Our Event</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(clamp(280px, 90vw, 400px), 1fr))', gap: 'clamp(24px, 4vw, 40px)', justifyContent: 'center' }}>
          {events.map((e, i) => (
