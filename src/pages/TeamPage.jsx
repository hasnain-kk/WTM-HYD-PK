  ...
  return (
    <div className="layout-section">
      <section className="grid-container">
        <h1 style={{ fontSize: 'clamp(2.5rem, 8vw, 4rem)', marginBottom: 'clamp(32px, 8vw, 64px)', textAlign: 'center', color: 'var(--deep-blue)' }}>Meet Our Team</h1>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(clamp(280px, 100%, 350px), 1fr))', gap: '32px', justifyContent: 'center' }}>
          {visibleTeam.map((member) => (
            <div key={member.id} className="surface-card" style={{ padding: 'clamp(24px, 5vw, 40px)', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
