    ...
    <header className="header-container" style={{ zIndex: 2000 }}>
      <div className="grid-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', flexWrap: 'nowrap', gap: '12px', position: 'relative', zIndex: 2001 }}>
        ...
        <nav style={{ display: 'flex', alignItems: 'center' }}>
          {isIWDPage ? (
            <div 
              style={{ fontWeight: 'bold', color: '#0033BD', background: 'rgba(255,255,255,0.8)', padding: '8px clamp(12px, 2.5vw, 24px)', borderRadius: '100px', fontSize: '0.85rem', border: '2px solid rgba(255,255,255,0.5)', whiteSpace: 'nowrap', cursor: 'not-allowed', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}
            >
              Registration Closed
            </div>
          ) : (
